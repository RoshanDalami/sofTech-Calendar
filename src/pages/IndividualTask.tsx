...
export default function IndividualTask() {
  ...
  return (
    <>
      ...
      <div className="flex w-[100vw]   min-h-screen flex-col overflow-x-auto  bg-slate-100   md:px-10 ">
        <section className="pb-2 pt-4 text-3xl">
          <p className="text-3xl font-bold left-3 fixed " key={singleTask.id}>
            {singleTask.title}
          </p>
        </section>
        ...
        <div className="flex w-[1000px] md:w-full  overflow-x-scroll mx-5 mt-10   items-center md:justify-between  gap-3 ">
          ...
          <section className=" relative h-[70vh] w-72 md:w-1/4 overflow-hidden rounded-md border border-black/60 ">
            <h1 className="z-10 bg-slate-200 px-1 py-3 text-xl  ">
              ...
              <p className="px-1 text-sm">{"This task hasn't been started "}</p>
            </h1>
            <div className="h-[57vh] overflow-auto  ">
              {newTaskList.length > 0
                ? singleTask.todo.map((todo: any) => {
                    return (
                      <section
          ...
          {/* backlog  */}
          <section className=" h-[70vh] md:w-1/4 w-72 overflow-hidden rounded-md border border-black/60 ">

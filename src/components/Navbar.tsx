          ...
          <div className="">
            <div className="px-2  sm:px-6 lg:px-8 ">
              <div className="relative  flex h-16 items-center justify-between">
                ...
                <div className="flex items-center justify-center sm:items-stretch sm:justify-start w-[90vw]   ">
            ...
            <div className="text-lg hidden md:absolute right-4 top-3 ">
              <p>
                Time: {englishToNepaliDigitConverter(time.toLocaleTimeString())}
              </p>
              <div>
                Date:{" "}
                {`${englishToNepaliDigitConverter(
                  JSON.stringify(date.getBS().year)
                )}/${englishToNepaliDigitConverter(
                  JSON.stringify(date.getBS().month)
                )}/${englishToNepaliDigitConverter(
                  JSON.stringify(date.getBS().date)
                )}`}{" "}
                {nepaliDays[date.getBS().day!]}
              </div>
            </div>
